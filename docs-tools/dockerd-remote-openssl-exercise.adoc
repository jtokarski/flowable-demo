...
4. Create Docker context (PowerShell)
+
----
docker context create fedo40              `
  --description "Fedora 40 VirtualBox"    `
  --docker "host=tcp://192.168.32.3:2376,ca=C:/java_installs/dockerd-tls/ca.pem,cert=C:/java_installs/dockerd-tls/cert.pem,key=C:/java_installs/dockerd-tls/key.pem"

# use like:
docker --context fedo40 ps
----
