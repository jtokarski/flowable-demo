...
/*
 *
 * After some thinking through I've decided that VersioningRevision is not the best name because this
 * entity is about low-level entity versioning, not about business-layer versioning concept. Therefore,
 * it's better to name it EnversRevision to clearly indicate that it is:
 *   - managed entirely by Hibernate Envers
 *   - concerned specifically with ENtity VERsioning
 *
 */
@RevisionEntity
@Table(name = "EnversRevision")
@Entity
